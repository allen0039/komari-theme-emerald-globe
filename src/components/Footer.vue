  ...
  <footer class="w-full sm:flex-row sm:gap-4 max-w-[1280px] mx-auto p-4">
    <div class="flex flex-row items-center justify-between  text-xs text-muted-foreground">
      ...
      <div class="flex flex-wrap gap-1 items-center">
        ...
        >
          <a
            href="https://github.com/allen0039/komari-theme-emerald-globe" target="_blank" rel="noopener noreferrer"
            class="transition-opacity hover:opacity-80"
          >
            <span class="font-medium text-foreground">Emerald Globe</span>
          </a>
        </DataTooltip>
      </div>
    </div>
