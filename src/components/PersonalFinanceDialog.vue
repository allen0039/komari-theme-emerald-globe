  ...
  <Dialog v-model:open="open">
    ...
    <DialogContent class="max-h-[min(90vh,42rem)] max-w-2xl gap-0 overflow-hidden p-0">
      ...
      <div class="flex min-h-0 flex-col">
        ...
        <div class="max-h-[min(50vh,22rem)] overflow-y-auto p-2 sm:p-3">
          <label
            v-for="node in filteredNodes" :key="node.uuid"
            class="grid min-h-12 cursor-pointer grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 rounded-sm px-2 py-2 transition-colors hover:bg-muted/60 focus-within:ring-2 focus-within:ring-ring/50"
          >
            <input
